...
public class sWorld {
	...
	private void initPlayers() {
		...
		// TODO: Receive ready msg
		
		
		while (!m_stringListener.isReady() &! m_stringListener.isAlive()){
		}
	...
	public class ClientListener extends Thread {
		...
		public void run() {
			...
			do {
				...
				sEntityManager.getInstance().setShipKeys(data, m_hash.get(p.getAddress().getHostAddress() + ":" + p.getPort()));
