...
public final class Const {
    ...
    public final static double		INTERPOLATION_TIME = 100;
    ...
    public final static double 	SHIP_ROTATION = 0.067; // Rotate ship by this many radians (per frame) when turning
